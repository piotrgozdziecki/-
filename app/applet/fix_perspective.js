...
const newStatus = `<div class="status-panel">
        ...
        <div id="badge-clock" class="stat-badge badge-clock">🕒 03:15</div>
        <div id="badge-combo" class="stat-badge badge-combo">🔥 COMBO x1</div>
        <div id="badge-zoom" class="stat-badge" onclick="toggleZoom()" style="border-color: #38bdf8; color: #7dd3fc; pointer-events: auto; cursor: pointer;">🔍 <span id="badge-zoom-label">0.62x</span></div>
      </div>`;
